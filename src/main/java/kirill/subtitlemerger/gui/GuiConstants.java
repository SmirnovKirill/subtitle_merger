...
public class GuiConstants {
    ...
    /**
     * If a video file for which subtitles are being loaded has a size in bytes greater than or equal to this number
     * then there will be a message before the cancel link saying that the operation may take a while.
     */
    public static final long LOADING_CANCEL_DESCRIPTION_THRESHOLD = 1024 * 1024 * 1024L;

    /**
     * If a video file for which subtitles are being injected has a size in bytes greater than or equal to this number
     * then there will be a message before the cancel link saying that the operation may take a while.
     */
    public static final long INJECTING_CANCEL_DESCRIPTION_THRESHOLD = 1024 * 1024 * 1024L;
